...
SELECTS: tuple[GuideVaultSelectDescription, ...] = (
    GuideVaultSelectDescription(
        ...
        value_keys=("background", "reader.background", "backgroundName", "reader.backgroundName", "backgroundDisplayName", "reader.backgroundDisplayName", "selectedBackground", "reader.selectedBackground"),
        options_keys=("backgrounds", "availableBackgrounds", "installedBackgrounds", "backgroundOptions", "reader.availableBackgrounds", "reader.installedBackgrounds", "reader.backgrounds", "settings.backgrounds", "settings.availableBackgrounds"),
